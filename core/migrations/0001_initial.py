    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modificado', models.DateField(auto_now=True, verbose_name='Atualização')),
                ('ativo', models.BooleanField(default=True, verbose_name='Ativo ?')),
                ('services', models.CharField(max_length=100, verbose_name='Serviços')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', stdimage.models.StdImageField(force_min_size=False, upload_to='Equipe', variations={'thumb': {'crop': True, 'heigth': 480, 'width': 480}}, verbose_name='Imagem')),
